...
class Wiiboard:
    ...
    def connect(self, address):
        ...
        if self.receivesocket and self.controlsocket:
            print("Connected to Wiiboard at address " + str(address))
            ...
            print("Could not connect to Wiiboard at address " + str(address))
    ...
    def discover(self):
        ...
        for bluetoothdevice in bluetoothdevices:
            if bluetoothdevice[1] == BLUETOOTH_NAME:
                ...
                print("Found Wiiboard at address " + str(address))
        if address is None:
